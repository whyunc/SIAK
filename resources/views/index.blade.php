			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href={{asset("mahasiswa")}} class=""><i class="lnr lnr-user"></i> <span>Mahasiswa</span></a></li>
						<li><a href={{asset("matkul")}} class=""><i class="lnr lnr-book"></i> <span>Mata Kuliah</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
